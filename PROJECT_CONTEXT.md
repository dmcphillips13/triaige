...
- [ ] Step 22.3: PR run cards should show gate status — indicate when the merge gate has been satisfied (all failures addressed) vs still blocking; visual distinction between "action required" and "ready to merge" states on the runs list
