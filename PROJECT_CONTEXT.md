...
- [ ] Step 22.1: Fix GitHub OAuth session duration — token expires too frequently, forcing re-auth during normal usage; investigate token refresh flow and extend session lifetime
