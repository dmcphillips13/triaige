...
- [ ] Step 22.5: Main tab should work without requiring Settings setup — derive repo from existing runs or default to first available; current flow requires user to visit Settings and link a repo before Main tab shows anything
