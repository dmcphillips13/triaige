...
- [ ] Step 22.1: Delete stale PR comments when runs are superseded — store comment ID on creation, delete when run is auto-closed so only the latest triage comment remains
